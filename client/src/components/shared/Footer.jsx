    ...
    <footer className="border-border bg-secondary w-full border-t py-12 transition-colors sm:py-16">
      <Container>
        <div className="grid grid-cols-1 gap-10 md:grid-cols-12 md:gap-12">
          {/* Identity & Positioning (Spans 6 cols on desktop) */}
          ...
          {/* Symmetrical 2-Column Grid on Mobile (Explore + Connect) */}
        ...
        {/* Symmetrical Bottom Bar: Copyright (Left) & Back to Top (Right) */}
        <div className="border-border/80 text-muted-foreground mt-12 flex items-center justify-between border-t pt-6 font-mono text-xs">
